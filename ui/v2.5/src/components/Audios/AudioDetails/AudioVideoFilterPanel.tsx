...
import { VIDEO_PLAYER_ID } from "src/components/AudioPlayer/util";
import * as GQL from "src/core/generated-graphql";

interface IAudioVideoFilterPanelProps {
...
export const AudioVideoFilterPanel: React.FC<IAudioVideoFilterPanelProps> = (
  props: IAudioVideoFilterPanelProps
) => {
  ...
  function onRotateAndScale(direction: number) {
    ...
    const audioWidth = file?.width ?? 1;
    const audioHeight = file?.height ?? 1;
    const audioAspectRatio = audioWidth / audioHeight;
    const audioNewAspectRatio = audioHeight / audioWidth;
  ...
  return (
    <div className="container audio-video-filter">
      <div className="row form-group">
...
export default AudioVideoFilterPanel;
