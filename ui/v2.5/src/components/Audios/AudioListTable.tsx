...
export const AudioListTable: React.FC<IAudioListTableProps> = (
  ...
  const ResolutionCell = (audio: GQL.SlimAudioDataFragment) => (
  ...
  const FrameRateCell = (audio: GQL.SlimAudioDataFragment) => (
    <ul className="comma-list">
      {audio.files.map((file) => (
        <li key={file.id}>
          <span>
  ...
  const VideoCodecCell = (audio: GQL.SlimAudioDataFragment) => (
    <ul className="comma-list">
      {audio.files.map((file) => (
        <li key={file.id}>
